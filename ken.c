...
// FILETYPES
/* Moved to syntax.c due for making pluggable filetype support.
   To add a new filetype support include the file in syntax.c and recompile.
   */
...
void initEditor(){
  ...
  E.cx = E.rx = E.cy = E.numrows = E.rowoff = E.coloff = E.dirty = 0;
  E.row = NULL;
  E.filename = NULL;
  E.statusmsg[0] = '\0';
  E.statusmsg_time = 0;
